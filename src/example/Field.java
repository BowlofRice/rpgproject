...
public class Field extends Canvas{
	...
	int dx;
	int dy;
	public int xEnemyCoor=18;//coordinates for an enemy
	public int yEnemyCoor=1;
	...
	public void paint(Graphics g){
		...
		case 2://map 1
			...
			maptest.moveEnemy(g, maptest.MapTraversalOne, 9, 0);
			maptest.paintCharacter(g, xAllyCoor, yAllyCoor, allyFlag);//draws allies
			break;
		case 3:
			map2test.paint(g);
			map2test.moveEnemy2(g, map2test.MapTraversalTwo, xEnemyCoor, yEnemyCoor);
			break;
		case 4:
			map3test.paint(g);
			map3test.moveEnemy3(g, map3test.MapTraversalThree, 0, 0);
			break;
	}
